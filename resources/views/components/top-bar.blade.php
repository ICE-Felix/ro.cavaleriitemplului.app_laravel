...
<header class="top-bar">
    ...
    <div class="flex items-center ltr:ml-auto rtl:mr-auto">
        ...
        @if(config('app.darkmode_enabled') === true)
            <!-- Dark Mode -->
        ...
        <div class="dropdown self-stretch">
            ...
            <div class="custom-dropdown-menu p-5 text-center">
                ...
                <div class="flex justify-around">
                    <a href="{{ config('links.documentation.user_guide') }}" class="p-5 text-normal hover:text-primary">
            ...
            <div class="custom-dropdown-menu w-64">
                ...
                <div class="p-5">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <a href="#no-link" class="flex items-center text-normal hover:text-primary" onclick="event.preventDefault(); this.closest('form').submit();">
